...
public class CarrinhodeCompras {
    ...
    public void mostrarProdutosCarrinho () throws IOException {
        ...
        for (int i=0; i< carrinhodeCompras.size(); i++)
        {
               ...
               //CAPTURA NOME DO OBJETO ATRAVï¿½S DO INDEX ONDE ESTï¿½ ARMAZENADO NA LISTA LISTA (COLLETION)
               Double precoProduto = carrinhodeCompras.get(i).getPreco();
               //CAPTURA NOME DO OBJETO ATRAVï¿½S DO INDEX ONDE ESTï¿½ ARMAZENADO NA LISTA LISTA (COLLETION)
               int id_produto = i;
               //O ID DO PRODUTO SE REFERE AO INDEX DA COLETION ONDE O OBJETO ESTï¿½ ARMAZENADO
